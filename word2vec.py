...
with graph.as_default():
    ...
    #tf.nce_loss automatically draws a sample of the negative labels each
...
with tf.Session(graph=graph) as sess:
    ...
    for step in xrange(num_steps):
        ...
        if step % 2000 == 0:
            if step > 0:
                average_loss /= 2000
            #The average loss is an estimate of the loss over the last 2000 batchs.
